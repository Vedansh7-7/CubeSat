...
#         # Entry for COM Port
#         self.com_label = ctk.CTkLabel(self.master, text="COM Port:")
#         self.com_label.pack(pady=10)
#         self.com_entry = ctk.CTkEntry(self.master)
#         self.com_entry.pack(pady=5)

#         # Entry for CSV File Path
#         self.file_label = ctk.CTkLabel(self.master, text="CSV File Path:")
#         self.file_label.pack(pady=10)
#         self.file_entry = ctk.CTkEntry(self.master)
#         self.file_entry.pack(pady=5)

#         # Status label
#         self.status_label = ctk.CTkLabel(self.master, text="OFFLINE", text_color="red", font=("Helvetica", 12))
...
# #         # Entry for COM Port
# #         self.com_label = ctk.CTkLabel(frame, text="COM Port:")
# #         self.com_label.pack(pady=10)
# #         self.com_entry = ctk.CTkEntry(frame)
# #         self.com_entry.pack(pady=5)

# #         # Entry for CSV File Path
# #         self.file_label = ctk.CTkLabel(frame, text="CSV File Path:")
# #         self.file_label.pack(pady=10)
