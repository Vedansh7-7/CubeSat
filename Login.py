...
frame = ctk.CTkFrame(root, fg_color="#1C191C", width=513, height=270)
...
user_label = ctk.CTkLabel(frame, text="USERNAME:", text_color="#844A84", font=ctk.CTkFont(family="Inter", size=18, weight="normal"))
